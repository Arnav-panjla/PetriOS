...
- [Hardware / CAD deck](PPTs/Hardware_CAD_Midterm_2026.pptx) — iteration history, final CAD, RPi OS decision
- [Vision deck](PPTs/vision_antibiotic_reading.pptx) — disc-code reading, pre-Gemma tests, Gemma 3 4B
